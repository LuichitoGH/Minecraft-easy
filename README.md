...
El mdo continua en desarrollo, en el momento estos son los contenidos que añade:
- 77 Crafteos nuevos
- +10 Armaduras nuevas
...
por lo que si se quiere una buena experiencia sin bugs lo mejor es jugar en este modo.7
- El mod aun no esta del todo optimizado par multijugador, por lo tanto si se enceuntra un bug, probablemente ya se este arreglando.
